                ...
                <section class="module">
                    <div class="module-inner">
                        <div class="module-heading">
                            <h3 class="module-title">Testimonial Edit</h3>
                        </div>
                        <div class="module-content collapse show" id="content-4">
                            <div class="module-content-inner pb-0">
                                <form class="user-form" method="POST" action="/admin/testi/update" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group form-row">
                                        ...
                                        <div class="form-group form-row">
                                            ...
                                            <div class="col-lg-10 col-md-9 col-12">
                                                ...
                                                <textarea name="deskripsi" id="deskripsi" cols="30" rows="5" class="form-control">{{ $testi->deskripsi }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group form-row avatar">
                                                ...
                                                <div class="form-inline col-lg-10 col-md-9 col-12">
                                                    ...
                                                    <label for="image">{{ $testi->image }}</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group form-row">
                                        <div class="col-xl-10 col-lg-9 col-12 offset-lg-2 offset-md-3">
                                           ...
                                           <a href="/admin/testi" class="btn btn-default">Kembali</a>
