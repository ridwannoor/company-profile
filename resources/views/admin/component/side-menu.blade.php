<nav class="side-menu">
    <ul class="nav">
        ...
        <li><a href="/admin/sponsor"><span class="pe-icon pe-7s-config icon"></span> Sponsor</a></li>
        <li><a href="#"><span class="pe-icon pe-7s-credit icon"></span> Work</a></li>
        <li><a href="/admin/testimonial"><span class="pe-icon pe-7s-chat icon"></span> Testimonial</a></li>
